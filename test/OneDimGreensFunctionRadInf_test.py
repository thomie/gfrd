...
class OneDimGreensFunctionRadInfTestCase( unittest.TestCase, 
    ...
    def setUp( self ):
        ...
        self.gf = mod.OneDimGreensFunctionRadInf( D, kf )
    ...
    def test_DrawTime_r0_equal_sigma_kf_zero( self ):
        ...
        gf = mod.OneDimGreensFunctionRadInf( D, kf  )
...
if __name__ == "__main__":
    ...
    suite = loader.loadTestsFromTestCase( OneDimGreensFunctionRadInfTestCase )
